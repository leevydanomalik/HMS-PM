...
import com.bitozen.hms.web.service.migration.termination.TerminationMigrationService;
...
@Service
@Slf4j
public class TerminationMigrationHystrixService {

    @Autowired
    TerminationMigrationService processor;
    ...
    public GenericResponseDTO<String> saveUploadedTerminationFile(MultipartFile upload) {
        GenericResponseDTO<String> response = new GenericResponseDTO().successResponse();
        processor.processTermination(upload);
