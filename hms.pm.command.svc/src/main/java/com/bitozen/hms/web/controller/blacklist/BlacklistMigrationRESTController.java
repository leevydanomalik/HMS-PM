...
import com.bitozen.hms.web.hystrix.blacklist.BlacklistMigrationHystrixService;
...
public class BlacklistMigrationRESTController {
    ...
    @SneakyThrows
    @PostMapping("/post.blacklist.migration")
    @CrossOrigin(origins = "*",
    ...
    public ResponseEntity<GenericResponseDTO<String>> uploadTemplateDocumentFile(@RequestParam("file") MultipartFile upload) {
        ...
        GenericResponseDTO<String> response = service.saveUploadedBlacklistFile(upload);
