...
import com.bitozen.hms.web.service.migration.blacklist.BlacklistMigrationService;
...
@Service
@Slf4j
public class BlacklistMigrationHystrixService {

    @Autowired
    BlacklistMigrationService processor;
    ...
    public GenericResponseDTO<String> saveUploadedBlacklistFile(MultipartFile upload) {
        GenericResponseDTO<String> response = new GenericResponseDTO().successResponse();
        processor.processBlacklist(upload);
